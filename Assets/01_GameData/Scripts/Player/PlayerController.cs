...
//    private Vector2 _dashRequestMoveInput;
...
//    // State machine dash request
//    public bool DashRequested { get; private set; }


//    // (Optional) expose input lock state for debugging
//    public bool IsInputEnabled => _inputEnabled;

//    public void ConsumeDashRequest()
//    {
//        DashRequested = false;
//        _dashRequestMoveInput = Vector2.zero;
//    }

//    /// <summary>
//    /// Called by the state machine when it decides to actually start dash.
...
//        if (!IsGrounded && !CanAirDash) return false;
...
//        // Use requested input; fallback to last move input
//        Vector2 dashInput = (_dashRequestMoveInput.sqrMagnitude > 0.01f) ? _dashRequestMoveInput : _lastMoveInput;
...
//        // request dash; state machine will validate and start it
//        DashRequested = true;

//        // snapshot current move input for dash direction
//        _dashRequestMoveInput = (_moveInput.sqrMagnitude > 0.01f) ? _moveInput : _lastMoveInput;
//    }
